            ...
            {data?.data.data.map((product) => {
              return (
                <div className=" col-md-4 col-lg-3  " key={product.id}>
                  <div className=" rounded-2   m-1 product position-relative pb-2 ">
                    <i
                      className={`fa-${wishlistItem.includes(product.id) ? "solid" : "regular"
                        }  fa-heart fa-solid  cursor-pointer p-5 fs-3 position-absolute heartIcon end-0 bottom-0 `}
                        style={{ color: wishlistItem.includes(product.id) ? '#dc3545' : '' }}
                        onClick={() => {
                    ...
                    <Link to={`productDetails/${product.id}`}>
                      ...
                      <h2 className="text-muted h6 fw-semibold px-3 cursor-pointer">
                    ...
                    <button
                      className="btn bg-main text-light d-block w-50 mx-auto m-3 "
                      onClick={() => {
